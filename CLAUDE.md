...
- **BigNumber uses zigzag LEB128**: Exponent and significand are each encoded as zigzag LEB128. The significand incorporates its sign.
...
- `encodeZigzagLEB128()` / `encodeSignedZigzagLEB128()` handle BigNumber encoding.
...
- `decodeZigzagLEB128()` / `decodeSignedZigzagLEB128()` handle BigNumber decoding.
